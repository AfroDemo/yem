...
export default function RequestMentorshipPage() {
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          <button className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground h-10 w-10">
            <Link href="/dashboard/mentors" className="flex items-center justify-center">
        ...
        <div className="max-w-2xl mx-auto rounded-lg border bg-white shadow-sm">
          <div className="p-6 pt-6 flex flex-col items-center text-center">
            ...
            <h2 className="text-2xl font-bold mb-2">Mentorship Request Sent!</h2>
            <p className="text-gray-500 mb-6">
              Your request has been sent to {mentor.name}. You'll receive a notification when they respond.
            </p>
              ...
              <ol className="space-y-2 text-sm text-left">
                <li className="flex gap-2">
                  ...
                  <span className="flex-1 pt-1">
                    {mentor.name} will review your request (typically within 2-3 business days)
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-blue-600 text-white text-xs">
                  ...
                  <span className="flex-1 pt-1">
                    If accepted, you'll be able to schedule your first mentoring session
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-blue-600 text-white text-xs">
                  ...
                  <span className="flex-1 pt-1">
                    You'll receive an email with next steps and preparation guidelines
                  </span>
                </li>
              </ol>
            </div>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <button className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground h-10 w-10">
          <Link href={`/dashboard/mentors/${mentorId}`}>
            <ArrowLeft className="h-5 w-5" />
          </Link>
        </button>
          ...
          <form onSubmit={handleSubmit}>
            <div className="rounded-lg border bg-white shadow-sm">
              <div className="p-6 border-b">
                ...
                <p className="text-gray-500">Tell {mentor.name} about yourself and your goals</p>
              </div>
              <div className="p-6 space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      {mentor.role} • {mentor.industry}
                    </p>
                  </div>
                </div>

                <div className="space-y-2">
                  <label className="text-sm font-medium leading-none">Select Mentorship Package</label>
                  <div className="space-y-3">
                    {mentor.mentorshipPackages.map((pkg) => (
                          ...
                          <div className="border rounded-md p-3 space-y-2">
                            <div className="grid grid-cols-2 gap-2 text-sm">
                              ...
                              <div>
                                ...
                                <p className="text-gray-500">{pkg.communication}</p>
                              </div>
                              <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="group relative">
                      ...
                      <div className="absolute z-10 hidden group-hover:block w-64 p-2 bg-white border rounded-md shadow-lg">
                        <p>
                          Be specific about what you hope to achieve through mentorship. This helps your mentor
                          prepare and tailor their guidance.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-2">
                  <label htmlFor="expectations" className="text-sm font-medium leading-none">
                    Your Expectations
                  </label>
                  <textarea
                    id="expectations"
              ...
              <div className="p-6 border-t flex flex-col sm:flex-row gap-3">
                <button className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2 sm:flex-1">
                  <Link href={`/dashboard/mentors/${mentorId}`}>Cancel</Link>
                </button>
                <button
                  type="submit"
          ...
          <div className="rounded-lg border bg-white shadow-sm">
            ...
            <div className="p-6 space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-500">
                  Clearly outline your goals and challenges. Specific requests are more likely to be accepted.
                </p>
              </div>
              <div className="space-y-2">
                <h4 className="font-medium text-sm">Show Commitment</h4>
                <p className="text-sm text-gray-500">
                  Demonstrate that you're serious about the mentorship and willing to put in the work.
                </p>
              </div>
              <div className="space-y-2">
                <h4 className="font-medium text-sm">Be Authentic</h4>
                <p className="text-sm text-gray-500">
                  Share your genuine challenges and aspirations. Authenticity helps build a stronger connection.
                </p>
              </div>
              <div className="space-y-2">
                <h4 className="font-medium text-sm">Respect Their Time</h4>
                <p className="text-sm text-gray-500">
                  Be clear about your availability and commitment to scheduled sessions.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="p-6 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Mentor reviews your request (2-3 days)</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-600 text-white">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Introductory call to align expectations</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-600 text-white">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Ongoing mentorship based on your package</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-600 text-white">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Regular check-ins on goal achievement</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-lg border bg-white shadow-sm">
            ...
            <div className="p-6">
              <p className="text-sm text-gray-500 mb-4">
                If you have questions about the mentorship process or need assistance with your request, our team is
                here to help.
              </p>
