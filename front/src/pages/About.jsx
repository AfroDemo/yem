  ...
  const values = [
    {
      ...
      title: "Innovation",
      description:
        "We believe in fostering creative thinking and new approaches",
    },
    {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-700 mb-6">
              We exist to bridge the gap between aspiring entrepreneurs and
              experienced professionals. Our platform connects young visionaries
              with mentors who can guide them through the challenges of starting
              and growing a business.
            </p>
            <p className="text-lg text-gray-700 mb-8">
              Since our founding in 2020, we've facilitated over 5,000
              mentorship connections and helped launch hundreds of successful
              ventures.
            </p>
            <RouterLink
              to="/register"
